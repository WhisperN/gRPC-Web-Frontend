 ...
 * @final
 */
proto.arrow.flight.protocol.FlightServiceClient =
 ...
 * @final
 */
proto.arrow.flight.protocol.FlightServicePromiseClient =
    function(hostname, credentials, options) {
  if (!options) options = {};
  options.format = 'text';
 ...
 */
proto.arrow.flight.protocol.FlightServiceClient.prototype.listFlights =
 ...
 *     The XHR Node Readable Stream
 */
proto.arrow.flight.protocol.FlightServicePromiseClient.prototype.listFlights =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/arrow.flight.protocol.FlightService/ListFlights',
      request,
 ...
 *     The XHR Node Readable Stream
 */
proto.arrow.flight.protocol.FlightServiceClient.prototype.getFlightInfo =
 ...
 */
proto.arrow.flight.protocol.FlightServicePromiseClient.prototype.getFlightInfo =
    function(request, metadata) {
 ...
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.arrow.flight.protocol.FlightDescriptor,
 *   !proto.arrow.flight.protocol.PollInfo>}
 */
const methodDescriptor_FlightService_PollFlightInfo = new grpc.web.MethodDescriptor(
  ...
  proto.arrow.flight.protocol.PollInfo.deserializeBinary
);
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.arrow.flight.protocol.PollInfo)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.arrow.flight.protocol.PollInfo>|undefined}
 *     The XHR Node Readable Stream
 */
proto.arrow.flight.protocol.FlightServiceClient.prototype.pollFlightInfo =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/arrow.flight.protocol.FlightService/PollFlightInfo',
      request,
      metadata || {},
      methodDescriptor_FlightService_PollFlightInfo,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.arrow.flight.protocol.PollInfo>}
 *     Promise that resolves to the response
 */
proto.arrow.flight.protocol.FlightServicePromiseClient.prototype.pollFlightInfo =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/arrow.flight.protocol.FlightService/PollFlightInfo',
      request,
 ...
 *     The XHR Node Readable Stream
 */
proto.arrow.flight.protocol.FlightServiceClient.prototype.getSchema =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/arrow.flight.protocol.FlightService/GetSchema',
      request,
 ...
 *     Promise that resolves to the response
 */
proto.arrow.flight.protocol.FlightServicePromiseClient.prototype.getSchema =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/arrow.flight.protocol.FlightService/GetSchema',
      request,
 ...
 *     The XHR Node Readable Stream
 */
proto.arrow.flight.protocol.FlightServiceClient.prototype.doGet =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/arrow.flight.protocol.FlightService/DoGet',
      request,
 ...
 *     The XHR Node Readable Stream
 */
proto.arrow.flight.protocol.FlightServicePromiseClient.prototype.doGet =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/arrow.flight.protocol.FlightService/DoGet',
      request,
 ...
 *     The XHR Node Readable Stream
 */
proto.arrow.flight.protocol.FlightServiceClient.prototype.doAction =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/arrow.flight.protocol.FlightService/DoAction',
      request,
 ...
 *     The XHR Node Readable Stream
 */
proto.arrow.flight.protocol.FlightServicePromiseClient.prototype.doAction =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/arrow.flight.protocol.FlightService/DoAction',
      request,
 ...
 *     The XHR Node Readable Stream
 */
proto.arrow.flight.protocol.FlightServiceClient.prototype.listActions =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/arrow.flight.protocol.FlightService/ListActions',
      request,
 ...
 *     The XHR Node Readable Stream
 */
proto.arrow.flight.protocol.FlightServicePromiseClient.prototype.listActions =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/arrow.flight.protocol.FlightService/ListActions',
      request,
